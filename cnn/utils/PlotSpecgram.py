...
""" plot spectrogram"""
def plotstft(audiopath, name, binsize=2**10, plotpath=None, colormap="gray", channel=0, alpha=1, offset=0):
...
os.chdir('/media/sc8013/ROXY FAT32/groupProject/rawData/rawAudio/wav/mono/16k/')
for file in glob.glob("*.wav"):
    print "Generating image for ", file
    plotstft('/media/sc8013/ROXY FAT32/groupProject/rawData/rawAudio/wav/mono/16k/' + file, '/media/sc8013/ROXY FAT32/groupProject/rawData/rawAudio/specgrams/' + file[:-4] + '.jpg')
